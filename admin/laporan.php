    ...
    <div class="row">
        <div class="col-md-5">
             <div class="form-group">
                ...
                <input type="date" class="form-control" name="tglm" value="<?php echo $tgl_mulai ?>">            </div>
        </div>
        <div class="col-md-5">
            <div class="form-group">
...
<p align="lift">
    <input class="btn btn-primary" type="button" value="Export PDF" onclick="window.open('export.php?tglm=<?=$_POST['tglm']?>&tgls=<?=$_POST['tgls']?>', '_blank')">
</p>
</div>
</div>
</div>
