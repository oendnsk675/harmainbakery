...
<table class="table">
	...
	<tr>
		<th>Deskripsi</th>
		<td><?php $detailproduk["deskripsi_produk"]; ?></td>
	</tr>
	<tr>
		<th>Stock</th>
		<td><?php echo $detailproduk["stock_produk"]; ?></td>
	</tr>
</table>
...
<div class="row">
	...
	<div class="col-md-3 text-center">
		<img src="../foto_produk/<?php echo $value["nama_produk_foto"] ?>" alt="" class="img-reponsive"><br>
