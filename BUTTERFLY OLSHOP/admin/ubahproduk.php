...
if (isset($_POST['ubah']))
 {
 	...
 	if (!empty($lokasifoto))
 	{
 		...
 		$koneksi->query("UPDATE produk SET nama_produk='$_POST[nama]',harga_produk='$_POST[harga]',berat='$_POST[berat]',foto_produk='$namafoto',deskripsi_produk=$_POST[deskripsi]',id_kategori=$_POST[id_kategori]
