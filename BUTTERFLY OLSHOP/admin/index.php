    ...
    <div id="wrapper">
        <nav class="navbar navbar-default navbar-cls-top " role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html">Butterfly Olshop</a> 
            </div>
           ...
           <!-- /. NAV TOP  -->
            ...
            <div class="sidebar-collapse">
				...
				<li class="text-center">
                    <img src="assets/img/kupu.jpg" class="user-image img-responsive"/>
					</li>
				
					
                    <li>
                        <a  href><i class="fa fa-dashboard fa fa-home"></i>Home</a>
                        <a  href=index.php?halaman=kategori><i class="fa fa-shopping-cart "></i>Kategori</a>
                        <a  href=index.php?halaman=produk><i class="fa fa-tags "></i>Produk</a>
