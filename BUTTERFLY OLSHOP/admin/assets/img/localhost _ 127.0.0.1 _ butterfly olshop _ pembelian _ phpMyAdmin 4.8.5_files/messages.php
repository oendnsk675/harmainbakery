...
PMA_messages['strIncompatibleMonitorConfigDescription'] = "The chart arrangement configuration in your browsers local storage is not compatible any more to the newer version of the monitor dialogue. It is very likely that your current configuration will not work any more. Please reset your configuration to default in the <i>Settings</i> menu.";
...
PMA_messages['strCountColumnExplanation'] = "This columns shows the amount of identical queries that are grouped together. However only the SQL Text is being compared, thus the queries other attributes such as start time may differ.";
...
PMA_messages['strAnalyzing'] = "Analysing…";
...
PMA_messages['strFinishMsg'] = "The first step of normalisation is complete for table \'%s\'.";
PMA_messages['strEndStep'] = "End of step";
PMA_messages['str2NFNormalization'] = "Second step of normalisation (2NF)";
...
PMA_messages['strWaitForPd'] = "Sit tight! It may take a few seconds depending on the data size and column count of the table.";
...
PMA_messages['str3NFNormalization'] = "Third step of normalisation (3NF)";
